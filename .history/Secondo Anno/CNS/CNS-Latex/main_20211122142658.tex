...
La fase di handshake è la fasa di negozaiazione inizilia e scambio di parametri. Si compone di:
\begin{itemize}
    \item Mutual Authentication;
    \item Accordo sugli algoritmi;
    \item Scambio di valori casuali;
    \item Scambio dei sgegreti o informationi per calcolare i segreti.
\end{itemize}
\end{document}