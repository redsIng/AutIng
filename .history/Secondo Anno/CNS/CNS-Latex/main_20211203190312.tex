...
\end{center}
Supponiamo di voler trasmettere un solo file e che questohe questo file sia di grandi dimensioni (quanto la grandezza della chiave dell'algoritmo di crifratura pubblico i.e. RSA-2048). Si prende una chiave da una funzione TRNG. Si 
\end{document}