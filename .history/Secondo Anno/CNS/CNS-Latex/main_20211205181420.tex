...
\end{itemize}
\begin{tabularx}{cc}
	Si ordinando i valori per cui calcolare il GCD in ordine decrescente e riempendo le rispettive colonne con i valori di a e b iniziali.\newline (a=1 su 51 poiché gli è associato e similrmente con b.)&
	\begin{tabularx}{c|c|c|c|c|}
		a&b&val&rem\\
		1&0&51&\\
		0&1&11&4\\
	\end{tabularx}\\
	A questo punto si effettua la divisione tra 51 e 11, si segna il divisore su rem (4) e il resto sul val (7) nella riga sottostante.\newline A questo punto per completare la riga successiva si effettua la sottrazione con la riga ancora più precedente con la riga precedente moltiplicata per il divisore.&
	\begin{tabularx}{c|c|c|c|c|}
		a&b&val&rem\\
		1&0&51&\\
		0&1&11&4\\
