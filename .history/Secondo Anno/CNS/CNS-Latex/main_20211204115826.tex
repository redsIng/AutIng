...
A questo punto un qualsiasi altro utente per verificare la corrttezza del documento ed effettuare un controllo di integrità, si prende la chiave pubblica PK e si inverte l'H(M)
\end{document}