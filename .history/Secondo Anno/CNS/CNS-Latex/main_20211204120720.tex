...
La differenza tra digital signature e MAC è che in MAC si genera un TAG attraverso la crittografia simmetrica e quindi la chiave K e condifisa tra sorgente e destinazione (Bisogna essere certi che la chiave sia uguale)
\end{document}