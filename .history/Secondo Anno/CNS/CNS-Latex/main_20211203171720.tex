...
Quello che occorre fare è la seguente cosa. Ipotizziamo di voler inviare dei dati confidenziali al server attraverso una un canale protetto. Quindi si inv
\end{document}