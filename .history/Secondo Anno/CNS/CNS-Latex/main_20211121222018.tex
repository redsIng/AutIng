...
due blocchei:
\begin{itemize}
    \item \textbf{Universa hash Function}: 
    \begin{center}
        Sono una famiglia di funzioni hash \(H_k(msg)\rightarrow\{0,1,\dots,m-1\}\). Questa famiglia è \emph{universale} se è difficile per un attacker, che
        non conosce la chiave, trovare una collisione. 
    \end{center};
