...
\textbf{Handshake Messages}
\begin{center}
    \includegraphics*[scale=0.8]{2021-11-22-14-56-02.png}
\end{center}
\begin{itemize}
    \item Prima fase di Handshake (\emph{Client Hello, Server Hello}) in cui ci si introduce per impostare i para
\end{itemize}
\end{document}