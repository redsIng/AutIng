...
\begin{enumerate}
    ...
    \item \textbf{Data transfer}: Nella fase di trasferimento dati si utilizza la crittografia a chiave simmetria e le chiavi di autenticazione dei messaggi dal segreto precedentemente condiviso.
\end{enumerate}
\end{document}