...
La \textbf{digital signature} funziona come segue. Supponiamo di avere un documento che vogliamo pubblicare nel web e vogliamo che solo io posso modificare il documento. Quindi, l'utente possiede una private key SK (decription) e una public key (Encription). La chiave privata rimane segreta e conosciuta solo da me. Per firmare questo messaggio possiamo 
\end{document}