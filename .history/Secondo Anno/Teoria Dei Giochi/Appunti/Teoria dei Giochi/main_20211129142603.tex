...
\begin{itemize}
    ...
    \end{center}
    \begin{enumerate}
        \item Per ciascuna di queste strategie, indica quanto paga, nel caso peggiore, chi la usa.
        \begin{center}
            \begin{table}
                    \begin{tabular}{|l|l|l|l|l|l|l|l|l|l|l|l|}
                        \hline
                        \xi_1^1 & \xi_1^2 & \xi_1^3 & \xi_1^4 & Z & max z & \xi_2^1 & \xi_2^2 & \xi_2^3 & \xi_2^4 & -Z & max z \\ \hline
                        ~       & ~       & ~       & ~       & ~ & ~     & ~       & ~       & ~       & ~       & ~  & ~     \\ 
                        ~       & ~       & ~       & ~       & ~ & ~     & ~       & ~       & ~       & ~       & ~  & ~     \\ 
                        ~       & ~       & ~       & ~       & ~ & ~     & ~       & ~       & ~       & ~       & ~  & ~     \\
                        \hline
