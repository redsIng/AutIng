...
\begin{itemize}
    ...
    \item \textbf{Strategia Conservativa}: Una strategia è detta minmax/conservativa per il giocatore i se risulta:$\tilde{C}_i(x_i)=min_{x_{i}\in X_{i}}C_i(x_i)$. Equivale a minimizzare quello che si dovrà pagare nel caso peggiore.
    ...
    \item \textbf{Valore di Shapley}:\begin{itemize}
        ...
        \end{itemize}
        \item \textbf{Esempi}:\begin{center}
            \includegraphics[scale=0.8]{images/image93.png}
        \end{center}
        \begin{center}
            \includegraphics[scale=0.8]{images/image92.png}
        \end{center}
    \end{itemize}
\end{itemize}
\end{document}
