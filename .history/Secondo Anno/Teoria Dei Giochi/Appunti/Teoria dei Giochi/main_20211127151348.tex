    ...
    \item \textbf{Importante:} Non è possibile calcolare il valore di Shapley se la somma della coalizione per rendere effettiva una legge è minore di \(\frac{N}{2}\)
        ...
        \item \textbf{Stable Marriage Problem:}\begin{itemize}
            ...
            \item\textbf{Algoritmo di Gale-Shapley}:\begin{itemize}
                \item \textbf{Prima Iterazione:} Alla prima iterazione ogni uomo si propone alla donna che preferisce. Ogni donna considera tutte le proposte che ha ricevuto e dice:\begin{itemize}
                    \item \textbf{FORSE}: all'uomo che prescerisce tra quelli che le si sono proposti;
                    \item \textbf{NO}: a tutti gli altri uomini che le si sono proposti.
                \end{itemize}
                ...
                \item\textbf{Considerazioni:}\begin{itemize}
                    \item \textbf{Il Matchin è stabile.};
                    \item 
                \end{itemize}
            \end{itemize}
        \end{itemize}
