...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
count = 1;
intgBlocks = dee_find_system(figtitle,'SearchDepth',1,'BlockType','Integrator');
...
inBlocks   = dee_find_system(figtitle,'SearchDepth',1,'BlockType','Inport');
if ~isempty(inBlocks),
  numni    = muxputs-numse;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
outBlocks = dee_find_system(figtitle,'SearchDepth',1,'BlockType','Outport');
