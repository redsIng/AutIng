...
[flag,fig]  = deeflag(figtitle, true);
if flag,
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
currentname = get_param(figtitle,'MaskDisplay');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
textaxes = axes('parent',fig,'posi',[0 0 1 1],'vis','off');
textcolor = 'black';
...
tni = uicontrol('Style','Text',...
    ...
    'BackGroundColor',grey,...
    'String',[getString(message('Simulink:dee:labelNumOfInputs')),' '],...
    'Parent',fig,...
...
hb = uicontrol('Style','Push',...
    'Units','Normal',...
    'String',getString(message('Simulink:dee:buttonHelp')),...
    'CallBack',@deehelp,...
    'Position',[x y w h],...
    'Parent',fig,...
    'Tag','HELP');
...
tb = uicontrol('Units','Normal',...
    'Position',[x2,y,w,h],...
    'String',getString(message('Simulink:dee:buttonRebuild')),...
    'Callback',@toast,...
     'Parent',fig,...
    'Tag','REBUILD');
...
rb = uicontrol('Units','Normal',...
    'Position',[x3,y,w,h],...
    'String',getString(message('Simulink:dee:buttonUndo')),...
    'Callback',@revertit,...
    'Parent',fig,...
    'Tag','UNDO');
...
db = uicontrol('Units','Normal',...
    'Position',[x5,y,w,h],...
    'String',getString(message('Simulink:dee:buttonDone')),...
...
st = uicontrol('Style','Text',...
    'Units','Normal',...
    'String',getString(message('Simulink:dee:StatusInitializing')),...
    'HorizontalAlignment','Left',...
    'BackGroundColor',darkgrey,...
...
tseto = uicontrol('Style','Text',...
    'Units','Normal',...
    'String',[getString(message('Simulink:dee:labelNumberOfStates')),' '],...
    'BackGroundColor',grey,...
    'HorizontalAlignment','Left',...
    'Parent',fig,...
...
ticto = uicontrol('Style','Text',...
    'Units','Normal',...
    'String',[getString(message('Simulink:dee:labelTotal')),' '],...
    'BackGroundColor',grey,...
    'HorizontalAlignment','Left',...
    'Parent',fig,...
...
tnh = uicontrol('Style','Text',...
    'Units','Normal',...
    'String',[getString(message('Simulink:dee:labelName')),' '],...
    'HorizontalAlignment','Left',...
    'BackGroundColor',grey,...
    'Parent',fig,...
...
setit = uicontrol('Style','Text',...
    'Units','Normal',...
    'String',getString(message('Simulink:dee:labelFirstOrderEquationsFxu')),...
    'HorizontalAlignment','Left',...
    'BackGroundColor',grey,...
    'Parent',fig,...
...
sotit = uicontrol('Style','Text',...
    'Units','Normal',...
    'String',getString(message('Simulink:dee:labelOutputEquationsFxu')),...
    'HorizontalAlignment','Left',...
    'BackGroundColor',grey,...
    'Parent',fig,...
...
deetit = uicontrol('Style','Text',...
    'Units','Normal',...
    'String',getString(message('Simulink:dee:labelDifferentialEquationEditorFcnBlockSyntax')),...
    'HorizontalAlignment','Left',...
