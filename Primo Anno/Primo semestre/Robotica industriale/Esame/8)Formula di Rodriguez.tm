...
<\body>
  ...
  <\enumerate-roman>
    ...
    è una matrice antrisimmetrica <math|<with|color|red|\<b-S\><around*|(|<frac|\<pi\>|2>|)>>>:
    ...
    è una matrice antisimmetrica <with|color|blue|<math|\<b-up-S\><rsup|2><around*|(|<frac|\<pi\>|2>|)><with|color|black|:>>>
